      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            :<MenuItem onClick={() => handleCloseUserMenu}>
              <Typography textAlign="center" onClick={()=>{localStorage.setItem('email', ''); setEmail('')}}>{'log out'}</Typography>
            </MenuItem>
            }
            </Menu>
          </Box>
    ...
    return(
      <Grid item xs={12}>
        ...
        <Stack sx={{ margin:'64px 10% 0 10%'}} spacing={2}>
          ...
          <TextField margin="normal" required autoFocus  id='discription' name='discription' defaultValue={allInfo.description}/>
          {/* Tag */}
